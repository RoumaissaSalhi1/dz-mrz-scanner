...
import 'package:mrz_new/controllers/id_card/id_card_camera_controller.dart';

class IdCardCamera extends StatelessWidget {
  const IdCardCamera({super.key});

  @override
  Widget build(BuildContext context) {
    final IdCardCameraControllerImp controller = Get.put(IdCardCameraControllerImp());
